...
- composer install
- php artisan serve
- Postman Docs in MileApp.postman_collection.json

## ENV
```
DB_URI = ATLAS_DB_URL_HERE 
...
1. berdasarkan referensi data “package.json” diatas buatlah  *REST API, Unit Testing dan Dokumentasi* : 
    1. GET /package
    2. GET /package/{id}
    3. POST /package 
    4. PUT /package/{id}
